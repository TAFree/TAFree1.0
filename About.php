...
class About implements Product{
	...
	private $msg = array (
		'Information' => '<a id=\'TAFREE_A\' href=\'http://github.com/TAFree\'><b>TAFree</b></a>  is an online judge system for NTU CE Computer Programming course; it is open-source and welcome to keep hacking.<br>',
		'Contributors' => 'Developers:<br>林照傑(edlin851206)<br>簡翰鈺(weavile182)<br>周琪雅(v06c)<br>張如嫻(JoyChal)<br>吳育姿(derailment)<br><br>Advisor:<br>吳軒竹(GGJason)',
